import {SINKS, calleeName, contentOf, isConstant, isRawTextElement, sandboxCanEscape, splitByScript} from '../utils/html-sinks.js'
...
export default {
  meta: {
    type: 'problem',
    docs: {
      description: 'Disallow rendering unsanitized HTML through template bindings (`v-html`, `set:html`, `{@html}`, `dangerouslySetInnerHTML`, `innerHTML`, `<iframe srcdoc>`)',
      recommended: true,
