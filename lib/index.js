...
import noUnescapedOutput from './rules/no-unescaped-output.js'
...
import noUnsafeOutputContext from './rules/no-unsafe-output-context.js'
import requireSri from './rules/require-sri.js'
import windowOpenNoopener from './rules/window-open-noopener.js'
import {TEMPLATE_ENGINE_SYNTAX} from './utils/template-engine.js'
...
const plugin = {
  ...
  rules: {
    ...
    'no-unescaped-output': noUnescapedOutput,
    'no-unescaped-script-content': noUnescapedScriptContent,
    'no-unsafe-html': noUnsafeHtml,
    'no-unsafe-output-context': noUnsafeOutputContext,
...
plugin.configs.recommended = {
  ...
  rules: {
    ...
    'template-security/no-unescaped-output': 'error',
    'template-security/no-unescaped-script-content': 'error',
    'template-security/no-unsafe-html': 'error',
    'template-security/no-unsafe-output-context': 'error',
...
// `templateEngineSyntax` for `@html-eslint/parser`, by engine: `templateEngineSyntax.jinja`
export const templateEngineSyntax = TEMPLATE_ENGINE_SYNTAX
